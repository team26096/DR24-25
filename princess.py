...
async def run2():
    ...
    await motor.run_for_degrees(port.C, -875, 500)
    ...
    await motor.run_for_degrees(port.C, -250, 800)
    ...
    motor.run_for_degrees(port.C, 775, 1100)
...
async def run5():
   ...
   # move forward to get out of base
    ...
    await pivot_gyro_turn_abs(-200, 200, -3, True)
